...
compconf=/sas/configcomp/Lev1
   gridobjspwn=/sas/configcomp/Lev1/ObjectSpawner
   gridevagnt=/sas/configcomp/Lev1/Web/SASEnvironmentManager
...
then
 {
  ...
  echo "***********************************"
   ...
   ssh $instluser@$mastrsvr $compconf/sas.servers $1
     echo "   *** $grid1svr ***"
     ssh $instluser@$grid1svr $gridobjspwn/ObjectSpawner.sh $1
     ssh $instluser@$grid1svr $gridevagnt/$grid1svr/agent-5.8.0-EE/bin/hq-agent.sh $1
     echo "   *** $grid2svr ***"
     ssh $instluser@$grid2svr $gridobjspwn/ObjectSpawner.sh $1
     ssh $instluser@$grid2svr $gridevagnt/$grid2svr/agent-5.8.0-EE/bin/hq-agent.sh $1
     echo "   *** $grid3svr ***"
     ssh $instluser@$grid3svr $gridobjspwn/ObjectSpawner.sh $1
     ssh $instluser@$grid3svr $gridevagnt/$grid3svr/agent-5.8.0-EE/bin/hq-agent.sh $1
     ### For VA Customers ###
